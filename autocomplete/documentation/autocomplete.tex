...
\noindent
The representation is given as 
...
%\textbackslash include\{\selection{autocomplete.log} \\
%\textbackslash include\{\selection{autocomplete.out} \\
%\textbackslash include\{\selection{autocomplete.pdf} \\
%\textbackslash include\{\selection{autocomplete.synctex.gz} \\
